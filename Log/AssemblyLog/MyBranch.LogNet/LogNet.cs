...
namespace MyBranch.LogNet
{
    public class LogNet : IMyBranchLog
    {
        ...
        public void NomeArquivoLog(string nome = null)
        {
            BuidLogNet(nome);
        }
        ...
        private void BuidLogNet(string nomeArquivo = null)
        {
            ...
            {
                throw new Exception("Ocorreu um erro na biblioteca de log Log4Net", ex.InnerException);
            }
        }
        #endregion
    }
