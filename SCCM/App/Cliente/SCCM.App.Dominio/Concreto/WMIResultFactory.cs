...
namespace SCCM.App.Dominio
{
    public class WMIResultFactory : IWMIResult
    {
        ...
        public static IWMIResult Criar(bool executado, string dominio, string msgException, string innerException)
        {
            WMIResultFactory result = new WMIResultFactory();
            _executado = executado;
            _dominio = dominio;
            _exception = new ExceptionModel(msgException, innerException, true);
            _dataProc = DateTime.Now;

            return result;
        }
        public static IWMIResult Criar(string dominio, string msgException, string innerException)
        {
            WMIResultFactory result = new WMIResultFactory();
            _executado = false;
            _dominio = dominio;
        ...
        public static IWMIResult Criar(bool executado, string dominio, string msgResult, string msgException, string innerException)
        {
            WMIResultFactory result = new WMIResultFactory();
            _executado = executado;
            _dominio = dominio;
        ...
        public static IWMIResult Criar(string dominio, string msgResult, string msgException, string innerException)
        {
            WMIResultFactory result = new WMIResultFactory();
            _executado = false;
            _dominio = dominio;
        ...
        public static IWMIResult Criar(bool executado, string dominio, object resultado, string msgException, string innerException) 
        {
            WMIResultFactory result = new WMIResultFactory();
            _executado = executado;
            _dominio = dominio;
        ...
        public static IWMIResult Criar(string dominio, object resultado, string msgException, string innerException) 
        {
            WMIResultFactory result = new WMIResultFactory();
            _executado = false;
            _dominio = dominio;
        ...
        public static IWMIResult Criar(bool executado, string dominio, string msgResult, object resultado, string msgException, string innerException) 
        {
            WMIResultFactory result = new WMIResultFactory();
            _executado = executado;
            _dominio = dominio;
        ...
        public static IWMIResult Criar(string dominio, string msgResult, object resultado, string msgException, string innerException)
        {
            WMIResultFactory result = new WMIResultFactory();
            _executado = false;
            _dominio = dominio;
        ...
        public static IWMIResult SerializarResult<TResult>(string json)
        {
            ...
            {
                throw new System.Exception("Operação inválida", new System.Exception("Json de serialização em branco"));
            }
            ...
            if (modelResult.Exception != null)
                _exception = new ExceptionModel(modelResult.Exception.Msg, modelResult.Exception.MsgDetalhado, true);
